  ...
  return (
    <section className="flex justify-wrap items-center max-xl:flex-col-reverse">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <p className='mt-4 lg:max-w-lg info-text'>Embark on a shopping journey that redefines your experience with ndeatable deals. From premier selections to incredible savings, we offer unparalleled value that sets us apart.</p>
